                        ...
                        if(data.success){
                            ...
                            if(data.result==='1'){
                                ...
                                if(t.length>0){
                                    ...
                                    var t1=d.rzFtbInvoiceInfo02,t2=d.ftbBillDetailVos,t3=d.rzFtbInvoiceInfo01;
                                    if(t1.length>0){
                                    ...
                                    var accountNameBaoLi = '';
                                    var accountNoBaoLi = '';
                                    var accountBankBaoLi = '';
                                    if(t2.length>0){
                                        for(var i=0;i<t2.length;i++){
//                                        console.log($.getFormatNumber(t2[i].holdAmount))
                                            accountNameBaoLi = d.accountNameBaoLi;
                                            accountNoBaoLi = d.accountNoBaoLi;
                                            accountBankBaoLi = d.accountBankBaoLi;
                                            str2+='<tr>\
										<td align="center">'+(i+1)+'</td>\
										<td align="center">'+t2[i].ownRecordId+'</td>\
										<td align="center">'+t2[i].payerName+'</td>\
										<td align="center">'+t2[i].holderEnterprisesName+'</td>\
										...
										<td align="center">'+(t2[i].rate*100).toFixed(2)+'</td>\
							            ...
							            <tr>\
							              <td style="padding:5px 15px; text-indent:2em; text-align:right;">深圳鸿鑫商业保理有限公司</td>\
							            </tr>\
							            <tr>\
                                        ...
                                        $('.table4 tbody').html(str4);
                                        $('.accountNameBaoLi').html(accountNameBaoLi);
                                        $('.accountNoBaoLi').html(accountNoBaoLi);
                                        $('.accountBankBaoLi').html(accountBankBaoLi);
                                    }
                                    if(t3.length>0){
            ...
            addLotsTest:function(text){
                ...
                $.ajaxFn({
                    ...
                    data:{
                        ...
                        returnUrl: $.interfacePath.server +$.interfacePath.webApp+ "/template/bill/financingFinish.html?applicationId=" + this.applicationId,
                        callBackUrl:''
                    },
                    type:'POST',
                    dataType:'JSON',
